...
\hangindent=2em
Estrellado, R. A., Freer, E. A.,  Mostipak, J., Rosenberg, J. M., & Velásquez, I. C. (2020). *Data science in education using R*. London, England: Routledge. *Note.* All authors contributed equally. http://www.datascienceineducation.com/ <a href="https://github.com/data-edu/data-science-in-education"><img src = "/logos/github.png" style="width: 17.5px; height: 17.5px; margin-left: 1px;"></a>

## Articles Published in Refereed Journals (41)
...
\hangindent=2em
Kubsch, M., Krist, C., & Rosenberg, J. M. (in press). Distributing Epistemic Functions and Tasks - A framework for augmenting human analytic power with machine learning in science education research. *Journal of Research in Science Teaching*. https://osf.io/sg9jk/. *Note.* All authors contributed equally.
...
\hangindent=2em
Rosenberg, J. M., & Jones, R. S. (in preparation). *K-12 data science learning*. Paper commissioned by the National Academies of Sciences, Engineering, and Medicine for *Foundations of Data Science for Students in Grades K-12: A Workshop*.

## Editor-Reviewed Articles Published in Journals (10)

\hangindent=2em
Hodge, E., López, F., & Rosenberg, J. M. (in press). How saying "We don’t teach Critical Race Theory here" can backfire: Guidance for responding to community concerns about Critical Race Theory in education". *Phi Delta Kappan*.

\hangindent=2em
Jiang, S., Lee, V. R., & Rosenberg, J. M. Data science education across the disciplines: Underexamined opportunities for K‐12 innovation. *British Journal of Educational Technology*. https://bera-journals.onlinelibrary.wiley.com/doi/full/10.1111/bjet.13258
...
## Articles Under Review (5)

Jones. R. S., & Rosenberg, J. M. (Accepted pending minor revisions). Characterizing whole class discussions about data and statistics with conversation profile analysis. *Journal of Mathematical Behavior.*
...
Rosenberg, J., Borchers, C., Burchfield, M. A., Anderson, D., Stegenga, S. M., & Fischer, C. (accepted pending minor revisions). When sharing isn't caring: How educational institutions share students’ personally identifiable information on Facebook. https://doi.org/10.35542/osf.io/zbw4h
...
\hangindent=2em
Burchfield, M., Rosenberg, J., Borchers, C., Thomas, T., Gibbons, B., & Fischer, C. (2021).  In I.-H. Hsiao, S. Sahebi, F. Bouchet, & J.-J. Vie (Eds), *Proceedings of the 14th International Conference on Educational Data Mining* (pp. 744-749). Are violations of student privacy “quick and easy”? Investigating the privacy of students’ images and names in the context of K-12 educational institution’s posts on Facebook. Proceedings of the 14th International Conference on Educational Data Mining (EDM). Paris, France. *Note.* This presentation received the best poster award.
