...
\hangindent=2em
Rosenberg, J. M., & Krist, C. (in press). Combining machine learning and human-driven interpretive methods to elaborate students’ ideas about the generality of their model-based scientific explanations. *Journal of Science Education and Technology*. *Nb.* Both authors contributed equally.
