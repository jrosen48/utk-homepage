...
\hangindent=2em
Frank, K. A., Lin, Q., Maroulis, S., Strassman, A., Xu, R., Rosenberg, J. M., Hayter, C., Mahmoud, R., Kolak, M., Dietz, T., & Zhang, L. (in press). Hypothetical case replacement can be used to quantify the robustness of trial results. *Journal of Clinical Epidemiology*. https://www.sciencedirect.com/science/article/pii/S0895435621000366 (*N.B.:* I was a scientific programmRer for this project).

\hangindent=2em
Ranellucci, J., Robinson, K., Rosenberg, J. M., Lee, Y.-K., Roseth, C., & Linnenbrink-Garcia. (advance online publication). Comparing the roles and correlates of emotions in class and during online video lectures in a flipped anatomy classroom. https://www.sciencedirect.com/science/article/abs/pii/S0361476X21000254
...
\hangindent=2em
Rosenberg, J. M., & Staudt Willet, K. B. (2021). Advancing social influence models in learning analytics. In XXX (Eds.), *Using Network Science in Learning Analytics: Building Bridges towards a Common Agenda*.
