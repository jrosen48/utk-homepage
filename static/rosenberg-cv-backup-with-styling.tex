...
\begin{center}
\emph{Curriculum Vitae}\linebreak
...
\hypertarget{ongoing-grants-principal-investigator-pi-co-pi-or-co-i}{%
\subsubsection{Ongoing Grants (Principal Investigator {[}PI{]}, Co-PI,
or Co-I)}\label{ongoing-grants-principal-investigator-pi-co-pi-or-co-i}}
...
machine learning and human-driven interpretive methods to elaborate
students' ideas about the generality of their model-based scientific
...
Educational Technology Research \& Development (2020) E-Learning and
Digital Media (2016: 2)\\
...
(2020). *tidycode: Analyze Lines of R Code the Tidy Way.
