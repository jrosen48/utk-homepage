...
background-image: url("/nsta-ss.png")
...
background-image: url("/endorsing-ngsschat-soc.png")
background-position: center
background-size: contain

---

background-image: url("/conversing-ngsschat-soc.png")
background-position: center
background-size: contain
...
```{r, include = FALSE}
d <- read_csv("centrality-measures.csv")
...
d1 <- read_csv("centrality-measures-c.csv")
...
- Can be important to teacher educators, too
- This type of communication aligns with recommendations for teacher professional development, such as, aligning to national and state standards (NGSS), focusing on content (science), and supporting a collaborative learning environment (Desimone & Garet, 2001)
- One promise of social media is that it helps to connect individuals who may not be otherwise (Gunawardena, Hermans, Sanchez, Richmond, Bohley, & Tuttle, 2009)
