...
(registered report accepted with minor revisions). Exploring pre-service
teachers' use of technology: The technology acceptance model and
...
\hangindent=2em Henriksen, D., Mehta, R., \& Rosenberg, J. M. (under
review). Supporting a creatively focused technology fluent mindset among
...
\hangindent=2em Blondel, D. V., Rosenberg, J. M., Sansone, A., Yang, B.
W., Linennbrink-Garcia, L., Schwarz-Bloom, R. D. (in preparation). The
...
preparation). Investigating the effects of interest and choice: An
...
validation data}. Retrieved from the Open Science
Framework.\url{https://osf.io/hc9fq/}
...
\hangindent=2em Rosenberg, J. M., \& Reid, J. (2019, January). \emph{The
roles of the Twitter hashtag \#NGSSchat in the context of science
education reform efforts}. Paper to be presented at the Association for
Science Teacher Education International Meeting, Savannah, GA.
(\emph{Nb. This paper was nominated for the ASTE John C. Park National
Technology Leadership Institute Award})
