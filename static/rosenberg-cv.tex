...
\hypertarget{articles-in-press-2}{%
\subsubsection{Articles In-Press (2)}\label{articles-in-press-2}}

\hangindent=2em

Aguilar, S. J., Rosenberg, J., Greenhalgh, S., Fütterer, T., Lishinski,
A., \& Fischer, C. A different experience in a different moment?
Teachers' social media Use before and during the COVID-19 pandemic.
\emph{AERA Open}. \url{https://doi.org/10.31219/osf.io/37pab}
...
\hypertarget{articles-under-review-4}{%
\subsection{Articles Under Review (4)}\label{articles-under-review-4}}
...
\& Thomas, T. (under review). ``We are trying to communicate the best we
can'': Understanding districts' communication on Twitter during the
COVID-19 pandemic. \emph{AERA Open}.
