...
\$308,262), \emph{Institute foe Education Sciences}
...
\$68,960), \emph{Institute foe Education Sciences}

\hypertarget{fellowships-and-awards}{%
\section{Fellowships and Awards}\label{fellowships-and-awards}}

2021, Best Poster Award, \emph{Fourteenth International Conference on
...
\hypertarget{articles-published-in-refereed-journals-36}{%
\subsection{Articles Published in Refereed Journals
(36)}\label{articles-published-in-refereed-journals-36}}

\hypertarget{articles-in-press-1}{%
\subsubsection{Articles In-Press (1)}\label{articles-in-press-1}}

\hypertarget{published-articles-36}{%
\subsubsection{Published Articles (36)}\label{published-articles-36}}
...
\emph{Journal of Research on Technology in Education}.
...
online publication). Open for whom? The need to define openscience for
...
Gibbons, B., \& Anderson, D., and Fischer, C. (2021). Posts on Facebook
by schools and districts and the potential risks to students' privacy.
\emph{Phi Delta Kappan}.
...
\hypertarget{articles-under-review-6}{%
\subsection{Articles Under Review (6)}\label{articles-under-review-6}}

Jones. R. S., \& Rosenberg, J. M. (under review). Characterizing whole
class discussions about data and statistics with conversation profile
analysis. \emph{Journal of Mathematical Behavior.}
...
Michela, E., Rosenberg, J., Kimmon, R., Sultana, O., Burchfield, M. A.,
\& Thomas, T. (conditionally accepted). ``We are trying to communicate
the best we can'': Understanding districts' communication on Twitter
during the COVID-19 pandemic. \emph{AERA Open}.
\url{https://doi.org/10.31219/osf.io/qpu8v}

Rosenberg, J. M., Schultheis, E., Kjelvik, M., Reedy, A., \& Sultana, O.
(under review). Big data, big canges? A survey of K-12 science teachers
in the United States on which data sources and tools they use in the
classroom. \emph{British Journal of Educational Technology.}
\url{https://edarxiv.org/tv4zg/}

Rosenberg, J. M., Kubsch, M., Wagenmakers, E.-J., \& Dogucu, M. (under
review). Why and how a Bayesian approach supports science educators and
learners to reason under scientific uncertainty. \emph{Science \&
Education}. \url{https://osf.io/aznyq/}
...
\hypertarget{workshops-16}{%
\subsection{Workshops (16)}\label{workshops-16}}
...
\hypertarget{outreach-and-engagement-10}{%
\section{Outreach and Engagement
(10)}\label{outreach-and-engagement-10}}
