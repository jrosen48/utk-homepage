...
2021-2022, Principal Investigator (Co-PI), \emph{Not only for scientists
and engineers: Advancing Bayesian methods for pre-collegiate learners}
(\$1,991), Supplemental funding to NSF Grant
...
research institute} (\$933,150; \textbf{PI}, Shaun Kellogg, North
Carolina State University; UTK subcontract: \$54,691. National Science
Foundation (NSF),
...
\hypertarget{articles-in-press}{%
\subsubsection{Articles In-Press}\label{articles-in-press}}
...
\subsubsection{Published Articles}\label{published-articles}}
...
\hangindent=2em Rosenberg, J. M. (2020, April). \emph{Discussion of
...
\hangindent=2em D'Angelo, C., \& Rosenberg, J. M. (2020, April).
