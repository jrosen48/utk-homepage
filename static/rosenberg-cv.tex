...
\hypertarget{published-articles-37}{%
\subsubsection{Published Articles (37)}\label{published-articles-37}}

\hangindent=2em +Michela, E., Rosenberg, J., Kimmons, R., +Sultana, O.,
\^{}Burchfield, M. A., \& \^{}Thomas, T. (in press). ``We are trying to
communicate the best we can'': Understanding districts' communication on
Twitter during the COVID-19 pandemic. \emph{AERA Open}
...
O. (under review). Big data, big canges? A survey of K-12 science
teachers in the United States on which data sources and tools they use
in the classroom. \emph{British Journal of Educational Technology.}
...
+Kenner, N., \& E+dwards, A. (2021, January). \emph{How can K-12 science
