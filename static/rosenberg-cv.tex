...
education using R}. London, England: Routledge. \emph{Note.} All authors
...
\hangindent=2em Kubsch, M., Krist, C., \& Rosenberg, J. M. (in press).
...
\hangindent=2em Jones. R. S., \& Rosenberg, J. M. (in press).
Characterizing whole class discussions about data and statistics with
conversation profile analysis. \emph{Journal of Mathematical Behavior.}
...
A Bayesian approach. \emph{Science \& Education}.
...
\hangindent=2em Rosenberg, J. M., \& Jones, R. S. (in preparation).
\emph{K-12 data science learning}. Paper commissioned by the National
Academies of Sciences, Engineering, and Medicine for \emph{Foundations
of Data Science for Students in Grades K-12: A Workshop}.
...
\hangindent=2em Jiang, S., Lee, V. R., \& Rosenberg, J. M. Data science
education across the disciplines: Underexamined opportunities for K‐12
innovation. \emph{British Journal of Educational Technology}.
...
Conference on Educational Data Mining (EDM). Paris, France. \emph{Note.}
...
Participant, \emph{National Academies Workshop on Data Science
Education}, Naional Academies of Sciences, Engineering and Medicine,
2022
