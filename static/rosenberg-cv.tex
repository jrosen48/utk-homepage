...
\begin{longtable}[]{@{}ll@{}}
\toprule
Resource & Logo\tabularnewline
\midrule
\endhead
PDF (preprint or open access) &\tabularnewline
GitHub Repository &\tabularnewline
Open Science Framework Repository &\tabularnewline
Google Scholar Entry &\tabularnewline
\bottomrule
\end{longtable}
