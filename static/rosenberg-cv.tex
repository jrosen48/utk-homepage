...
\textbf{\$5,489,253; \$4,401,492 as Principal Investigator {[}PI{]},
...
(\$299,836; with \emph{Co-PI} Alex Lishinski). National Science
Foundation {[}NSF{]}.
...
\hypertarget{articles-published-in-refereed-journals-41}{%
\subsection{Articles Published in Refereed Journals
(41)}\label{articles-published-in-refereed-journals-41}}
...
\url{https://osf.io/sg9jk/}. \emph{Note.} All authors contributed
equally.
...
Jones. R. S., \& Rosenberg, J. M. (Accepted pending minor revisions).
...
S. M., \& Fischer, C. (accepted pending minor revisions). When sharing
isn't caring: How educational institutions share students' personally
identifiable information on Facebook.
\url{https://doi.org/10.35542/osf.io/zbw4h}
