...
science education, computational research methods \endgroup
...
\subsection{Ongoing (Principal Investigator {[}PI{]} or
...
\subsection{Ongoing (Senior Personnel or
...
\hangindent=2em Rosenberg, J. M.,\& Lishinsli, A. (January, 2020).
...
Lishinsli, A., Rich, K., Longnecker, J., Mann. M., \& Sadovnik, A.
...
\subsection{Teaching Awards}\label{teaching-awards}}
...
\subsection{Ad-hoc Journal Article
...
\subsection{College-related Service}\label{college-related-service}}
...
\subsection{Departmental Service}\label{departmental-service}}
...
\subsection{Program Service and Service on Student
...
\subsection{Campus and Departmental
...
\subsection{R packages on Comprehensive R Archive Network
