...
First, let's access the data. I use rtweet to access 2,500 recent Tweets with the #rstats hashtag. 

```{r, load-setup, cache = FALSE}
library(rtweet)

d <- search_tweets("#rstats", n = 2500)
```
