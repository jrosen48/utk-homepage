---
title: Writing a recursive function in R - collecting data on replies to replies (to replies!) on Twitter
author: ''
date: '2020-02-07'
...
First, let's access the data. I use rtweet to access 5,000 recent Tweets with the #rstats hashtag. 
...
get_replies_recursive <- function(statuses) {
  ...
  if (length(new_statuses) > 0) {
    new_data_recursive <- get_replies_recursive(new_statuses) # this is the key line where the function calls itself, but passing new statuses
...
I'm unsure exactly how much more better (clear, efficient) using recursion is here, compared to the former approach I tried; I think this code is a bit simpler. I am also unsure how generally useful recursion is in real-life programming. Lastly, I'm not sure I did this quite right: I went down a bit of a recursive rabbit hole. But, this seemed to work, and I welcome any feedback about it. 