...
Spencer reflected on his presentation at a new conference in a way that, I think, lent insight into the conferneen - and the experience of attending a new conference for the first time (and the anxiety that can be associated with doing so).
